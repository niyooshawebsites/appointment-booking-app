...
const Qualifications = () => {
  ...
  return (
    <>
      <div className="w-full md:w-8/12  mx-auto p-2">
        <h2 className="mt-10 mb-4 text-center text-3xl text-pink-600">
          Qualifications
        </h2>
        <form
          className="w-10/12 md:w-6/12 mx-auto p-3 mt-1 rounded-md"
        ...
        >
          <div className="mt-4">
            ...
            <input
              ...
              className="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-2 ring-indigo-700 placeholder:text-gray-400 sm:text-sm sm:leading-6 px-3 mt-2"
            />
          </div>
          <div className="mt-4">
            <button
